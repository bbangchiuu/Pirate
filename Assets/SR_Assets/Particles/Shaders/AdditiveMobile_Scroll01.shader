...
Shader "GAP/AdditiveMobileDistortionScroll" {
    Properties {
        ...
        [Toggle] _DistortMainTexture ("Distort Main Texture", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma only_renderers d3d11 glcore gles gles3 vulkan metal
            #pragma target 2.0
...
////// Emissive:
                ...
                float4 _MainTexutre_var = tex2D(_MainTex,TRANSFORM_TEX(node_902, _MainTex));
