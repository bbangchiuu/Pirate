    ...
    public class JsonMapper
    {
        ...
        private static void RegisterBaseExporters()
        {
            ...
            base_exporters_table[typeof(DateTime)] =
                delegate (object obj, JsonWriter writer)
                {
                    string str = ((DateTime)obj).ToString(("yyyy-MM-ddTHH:mm:ss.fff"));
                    writer.Write(str);
                };
                                        ...
                                        int depth)
        {
            ...
            if (obj is Hiker.Networks.Data.Shootero.CardReward)
            {
                var r = obj as Hiker.Networks.Data.Shootero.CardReward;
                if (writer_is_private)
