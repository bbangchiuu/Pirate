...
public class CanvasHelper : MonoBehaviour
{
    ...
    public void AddSafeArea(SafeAreaHelper safeArea)
    {
        safeAreaTransform.Add(safeArea.rectTrans);
    }

    public void RemoveSafeArea(SafeAreaHelper safeArea)
    {
        safeAreaTransform.Remove(safeArea.rectTrans);
    }
    ...
    void Awake()
    {
        ...
        if (safeAreaTransform.Count == 0)
        {
            var safeArea = transform.Find("SafeArea") as RectTransform;
            if (safeArea != null && safeArea.GetComponent<SafeAreaHelper>() == null)
            {
                safeAreaTransform.Add(safeArea);
            }
        }
