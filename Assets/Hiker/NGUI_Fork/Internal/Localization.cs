...
static public class Localization
{
	...
	static public bool Has (string key)
	{
        ...
        // duongrs only support mobile system now
    ...
    static public string Get(string key, string lang)
    {
        return Get(key);
    }

    static public string GetLocalization(string key, string lang)
    {
