...
{
    [TaskDescription("Jump to a MainPlayer")]
    [TaskCategory("Shootero")]
    public class AIJumpToTarget : Action
    {
        ...
        public override void OnStart()
        {
            ...
            DonViChienDau main_player = QuanlyNguoichoi.Instance.PlayerUnit;
            
            if (NavMesh.SamplePosition(main_player.transform.position + dirRandom * randomRange, out hit, checkRange, filter))
            {
                haveTarget = true;
