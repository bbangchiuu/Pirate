...
public partial class CashShopUtils
{
    ...
    public static Dictionary<string, OfferStoreConfig> GetTargetOfferConfigs()
    {
        var config = ConfigManager.cashShopConfig["TargetOffer"];

        var result = JsonMapper.ToObject<Dictionary<string, OfferStoreConfig>>(config.ToJson());
        return result;
    }
    public static Dictionary<string, OfferStoreConfig> GetTruongThanhOfferConfigs()
    {
        var config = ConfigManager.cashShopConfig["TruongThanhOffer"];

        var result = JsonMapper.ToObject<Dictionary<string, OfferStoreConfig>>(config.ToJson());
        return result;
    }
    public static Dictionary<string, OfferStoreConfig> GetTetEventOfferConfigs()
    {
        var config = ConfigManager.cashShopConfig["TetEventOffer"];
